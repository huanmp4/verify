 ...
 * @version 0.1.0.0 
 * @date 2011-05-12 
 * @demo /gameact.qq.com/milo/core/base.html
 * @class milo.base  
 * <p>
...
(function(){
	var config = {
		loaderPath : "/ossweb-img.qq.com/images/js/milo/",//
		version : "20130701",
		expires : 30000
	}
 ...
 * </p>
 * <p>
 * 各模块的路径会定义到：<b>/ossweb-img.qq.com/images/js/milo/biz</b>
 * </p>
 * @demo /gameact.qq.com/milo/core/load.html
 */
 ...
 * @version 0.1.0.0 
 * @date 2011-07-21
 * @demo /gameact.qq.com/milo/core/bases.html
 * @class milo.array 
 ...
 * @version 0.1.0.0 
 * @date 2011-08-01
 * @demo /gameact.qq.com/milo/core/ready.html
 * @class milo.event 
 * 本类中所有方法被绑定到milo对象中，通过对milo.方法名进行调用。<br/> 
 * <p>
 * Example:
...
(function(){
	...
	function getAmsFile(amsActivityId,flowId, callback){
		...
		var _url = "/" + window.location.host + "/comm-htdocs/js/ams/v0.2R02/act/" + amsActivityId + "/act.desc.js";
		//_url = "/gw.qq.com/comm-htdocs/js/ams/v0.2R02/act/" + amsActivityId + "/act.desc.js";
	...
	function getDesc(obj, callback){
		...
		var actDesc = window["ams_actdesc_" + obj.actId],
			_url = "/" + window.location.host + "/comm-htdocs/js/ams/v0.2R02/act/" + obj.actId + "/act.desc.js";
...
//微博分享
amsCfg_24258 = {
	iActivityId : '3704', // AMS活动号
	id: '938',
	container: "carousel_container21921", // 指定内容容器ID，不指定则会自动生成一个
	frame: "carousel_frame21921", // 指定内容容器ID，必须
	prev: "prev21921", // 指定向前滚动按钮ID，可不指定
	next: "next21921", // 指定向后滚动按钮ID，可不指定
	complete:function(res){
		if(res['iRet']==0){
			shareToQzone();
			if(have_take_gift==0){
				amsSubmit(3704,24257);
				have_take_gift=1;
			}else{
				alert('感谢您的分享，但是每个玩家只能领取一次奖励!');
			}
			return false;
		}else{
			//alert(res['sMsg']);
...
var ams_actdesc_3704={"iActivityId":"3704","iWorkFlowId":"20130619014","sActivityName":"\u58a8\u5b88\u57ce\u89c4\u5206\u4eab\u6709\u5956\u6d3b\u52a8","iActivityStatus":"3","sServiceType":"s3","sServiceDepartment":"x5m2","dtBeginTime":"2013-07-04 00:00:00","dtEndTime":"2015-07-04 23:59:59","tOpenTime":"00:00:00","tCloseTime":"23:59:59","sActivityURL":"","iTableNum":"10","iShutdown":"0","sModules":[18,15,7,6],"iAreaRoleModId":"3607","iAreaRoleFlowId":"24256","flows":{"f_24090":{"iNeedLogin":"1","iNeedAreaRole":"0","iNeedAreaRoleService":"","sFlowName":"\u7528\u6237\u53cd\u9988\u6a21\u5757","functions":[{"method":"bugfeedback.bugFeedback","sExtModuleId":"3704"}]},"f_24255":{"iNeedLogin":"1","iNeedAreaRole":"0","iNeedAreaRoleService":"","sFlowName":"\u67e5\u8be2\u662f\u5426\u7ed1\u5b9a\u5927\u533a","functions":[{"method":"bindarea.bindarea","sExtModuleId":"3607"}]},"f_24256":{"iNeedLogin":"1","iNeedAreaRole":"0","iNeedAreaRoleService":"","sFlowName":"\u63d0\u4ea4\u5927\u533a\u7ed1\u5b9a\u4fe1\u606f","functions":[{"method":"bindarea.bindarea","sExtModuleId":"3607"}]},"f_24257":{"iNeedLogin":"1","iNeedAreaRole":"1","iNeedAreaRoleService":"","sFlowName":"\u62bd\u5956\u9886\u53d6\u6d41\u7a0b","functions":[{"method":"lottery.getGiftMain","sExtModuleId":"4157"}]},"f_24258":{"iNeedLogin":"1","iNeedAreaRole":"1","iNeedAreaRoleService":"","sFlowName":"\u63d0\u4ea4\u5fae\u535a\u5206\u4eab","functions":[{"method":"share.microblogFix","sExtModuleId":"938"}]},"f_24259":{"iNeedLogin":"1","iNeedAreaRole":"1","iNeedAreaRoleService":"","sFlowName":"\u7a7a\u95f4\u5206\u4eab\uff08\u56fa\u5b9a\u6587\u5b57\uff09","functions":[{"method":"share.qzoneFix","sExtModuleId":"938"}]},"f_24264":{"iNeedLogin":"1","iNeedAreaRole":"0","iNeedAreaRoleService":"","sFlowName":"\u67e5\u8be2\u662f\u5426\u5df2\u9886\u53d6\u793c\u5305","functions":[{"method":".","sExtModuleId":null}]}}}
