...
class PublishCourse(View):
    def get(self,request):
        context = {
            'categories': CourseCategory.objects.all(),
            'teachers': Teacher.objects.all()
        }
        return render(request,'cms/course/course.html',context=context)
...
def write_cms_add(request):
    return render(request,'cms/course/write_as_submit.html')